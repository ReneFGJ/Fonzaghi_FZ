...
echo '
		...
		<script type="text/javascript" src="../../_include/js/jquery-ui-datepicker-localisation/jquery.ui.datepicker-'.str_replace('_', '-', $LANG).'.js"></script>
		<script type="text/javascript" src="../../_include/js/jquery.maskedit.js"></script>
		<script type="text/javascript" src="../../_include/js/jquery.maskmoney.js"></script>
		<script type="text/javascript" src="../../_include/js/jquery.tagsinput.js"></script>
		<link rel="stylesheet" href="../../_include/css/calender_data.css" type="text/css" media="screen" />
		<link rel="stylesheet" href="../../_include/css/style_keyword_form.css" type="text/css" media="screen" />
	';

/*
 * Depend�ncias do dynatree e do tinymce
 */
//echo '<script type="text/javascript" src="../../_include/js/tinymce/tinymce.min.js"></script>';
//echo '<script type="text/javascript" src="../../_include/js/jquery/jquery.cookie.js"></script>';
echo '<script type="text/javascript" src="../../_include/js/jquery.dynatree.js"></script>';
